...
--
-- Host: localhost:8889
-- Generation Time: Oct 27, 2017 at 10:04 PM
...
(6, 'lk', 'lk', 'lk', 'lk', 'lk', 0, 'l', 'lk', 'lklkl', 1, 1, NULL, NULL, '2017-10-25 22:30:11', NULL),
...
(1, 'imagen-default.jpg', 'Imagen Defualt', 'Imagen por default', NULL, '2017-10-25 22:08:13', NULL);
...
(1, 'lj', 6, 0, 1, 'ljkll', 'lkj', NULL, NULL, 1, '2017-10-25 22:30:11'),
(2, 'Restaurante de comida expres', 7, 0, 1, 'razon', 'La parrila', NULL, NULL, 1, '2017-10-25 22:35:26');
...
(1, 1, '15', 'Ricas quesadillas con carne', '00:15:00', NULL, '2017-10-26 19:57:00', 1),
(1, 2, '10', 'Ricos tacos de adobada', '00:05:00', NULL, '2017-10-26 20:09:11', 1);
...
INSERT INTO `semana` (`idsemana`) VALUES
('DOMINGO'),
('JUEVES'),
('LUNES'),
('MARTES'),
...
ALTER TABLE `oferta_has_image`
  ADD PRIMARY KEY (`oferta_idoferta`,`image_idimage`),
...
--
ALTER TABLE `restaurante_platillo_ingrediente`
  MODIFY `idrest_plat_ing` int(11) NOT NULL AUTO_INCREMENT;
--
